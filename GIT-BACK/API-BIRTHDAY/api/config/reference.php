 ...
 *             is_public?: bool|Param, // If true, the service will be public, else private. // Default: true
 *             signature_algorithms: array<string, scalar|null|Param>,
 *             tags?: array<string, mixed>,
 *         }>,
 ...
 *             is_public?: bool|Param, // If true, the service will be public, else private. // Default: true
 *             serializers: list<scalar|null|Param>,
 *             tags?: array<string, mixed>,
 *         }>,
 *         loaders?: array<string, array{ // Default: []
 *             is_public?: bool|Param, // If true, the service will be public, else private. // Default: true
 *             signature_algorithms: array<string, scalar|null|Param>,
 *             serializers?: array<string, scalar|null|Param>,
 *             header_checkers?: array<string, scalar|null|Param>,
 *             tags?: array<string, mixed>,
 *         }>,
 *     },
 *     jwe?: array{
 *         builders?: array<string, array{ // Default: []
 *             is_public?: bool|Param, // If true, the service will be public, else private. // Default: true
 *             encryption_algorithms: array<string, scalar|null|Param>,
 *             tags?: array<string, mixed>,
 *         }>,
 ...
 *             signature_algorithms: array<string, scalar|null|Param>,
 *             encryption_algorithms: array<string, scalar|null|Param>,
 *             jws_serializers: array<string, scalar|null|Param>,
 *             jwe_serializers: array<string, scalar|null|Param>,
 *             jws_header_checkers?: array<string, scalar|null|Param>,
 *             jwe_header_checkers?: array<string, scalar|null|Param>,
 *             tags?: array<string, mixed>,
 *         }>,
 *         builders?: array<string, array{ // Default: []
 *             is_public?: bool|Param, // If true, the service will be public, else private. // Default: true
 ...
 *             is_public?: bool|Param, // If true, the service will be public, else private. // Default: true
 *             tags?: array<string, mixed>,
 *             value: scalar|null|Param, // The JWKSet object.
 *         },
 *         jku?: array{
 *             is_public?: bool|Param, // If true, the service will be public, else private. // Default: true
 *             tags?: array<string, mixed>,
 *             url: scalar|null|Param, // URL of the key set.
 *             headers?: array<string, mixed>,
 *         },
 *         x5u?: array{
 *             is_public?: bool|Param, // If true, the service will be public, else private. // Default: true
 ...
 *             is_public?: bool|Param, // If true, the service will be public, else private. // Default: true
 *             tags?: array<string, mixed>,
 *             path: scalar|null|Param, // Path of the key file.
 *             password?: scalar|null|Param, // Password used to decrypt the key (optional). // Default: null
 ...
 *             is_public?: bool|Param, // If true, the service will be public, else private. // Default: true
 *             tags?: array<string, mixed>,
 *             path: scalar|null|Param, // Path of the certificate file.
 *             additional_values?: array<string, mixed>,
 *         },
 *         values?: array{
 *             is_public?: bool|Param, // If true, the service will be public, else private. // Default: true
 ...
 *             is_public?: bool|Param, // If true, the service will be public, else private. // Default: true
 *             tags?: array<string, mixed>,
 *             secret: scalar|null|Param, // The shared secret.
 *             additional_values?: array<string, mixed>,
 *         },
 *         jwk?: array{
 *             is_public?: bool|Param, // If true, the service will be public, else private. // Default: true
 *             tags?: array<string, mixed>,
 *             value: scalar|null|Param, // The JWK object
 *         },
 *         x5c?: array{
 *             is_public?: bool|Param, // If true, the service will be public, else private. // Default: true
 *             tags?: array<string, mixed>,
 *             value: scalar|null|Param, // X509 certificate
 *             additional_values?: array<string, mixed>,
 *         },
 *         jwkset?: array{
 *             is_public?: bool|Param, // If true, the service will be public, else private. // Default: true
 *             tags?: array<string, mixed>,
 *             key_set: scalar|null|Param, // The key set service.
 *             index: mixed, // The index of the key in the key set.
 *         },
 *     }>,
 *     jwk_uris?: array<string, array{ // Default: []
 *         id: scalar|null|Param, // The service ID of the Key Set to share.
 *         path: scalar|null|Param, // To share the JWKSet, then set a valid path (e.g. "/jwkset.json").
 *         tags?: array<string, mixed>,
 *         is_public?: bool|Param, // If true, the service will be public, else private. // Default: true
 *     }>,
 *     jku_factory?: bool|array{
 *         enabled?: bool|Param, // Default: false
 *         client: scalar|null|Param, // HTTP Client used to retrieve key sets.
 *     },
 * }
